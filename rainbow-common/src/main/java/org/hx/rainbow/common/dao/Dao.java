...
public abstract interface Dao
{
  ...
  public abstract List<Map<String,Object>> query(String ds, String namespace,String statement,int limit, int pageNum);

  public abstract List<Map<String,Object>> query(String ds, String namespace,String statement, Map<String,Object> paramData);

  public abstract List<Map<String,Object>> query(String ds, String namespace,String statement,Map<String,Object> paramData, int limit, int pageNum);
  ...
  public abstract Map<String,Object> get(String ds, String namespace,String statement, Map<String,Object> paramData);
